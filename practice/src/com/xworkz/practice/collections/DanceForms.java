...
public class DanceForms {
    ...
    public static void main(String[] args) {
        ...
        danceforms1.add("salsa");
        danceforms1.add("kathak");
        danceforms1.add("break dance");
        danceforms1.add("mohiniyattam");
        System.out.println( "addAll method"+danceforms.addAll(danceforms1));
        System.out.println(danceforms);
        System.out.println(danceforms.removeAll(danceforms1));
        System.out.println(danceforms);
